...
const About = () => {
  ...
  const publications = [
    ...
    },
    {
    ...
    },
     {
      ...
      icon: "fa-solid fa-file-lines text-blue-500",
      title:
        "SMALL LANGUAGE MODELS FOR REAL-WORLD AI: A HYBRID REVIEW FRAMEWORK FOR ENTERPRISE & EDUCATIONAL DEPLOYMENTS",
      journal: "International Journal of Scientific Development and Research",
      date: "2026-02-23",
      url: "https://ijsdr.org/viewpaperforall.php?paper=IJSDR2602114",
    },
  ];
  ...
  const pmiMembership = {
    credential: "PMI® Membership",
    status: "Active",
    memberSince: "2026",
    chapter: "Pune-Deccan India Chapter",
  };
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-sky-50 border border-blue-100">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="font-semibold text-lg">{pmiMembership.credential}</p>
                      <p className="text-sm font-medium text-green-600 mt-1">{pmiMembership.status}</p>
                      <p className="text-xs text-gray-600 mt-2">Member Since: {pmiMembership.memberSince}</p>
                      <p className="text-xs text-gray-500 mt-1">{pmiMembership.chapter}</p>
                    </div>
        ...
        <div className="md:hidden space-y-5">
          ...
          <Accordion
            ...
            toggle={toggleSection}
          >
            <div className="p-3 rounded-xl bg-sky-50 border border-blue-100">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="font-semibold">{pmiMembership.credential}</p>
                  <p className="text-xs font-medium text-green-600 mt-1">{pmiMembership.status}</p>
                  <p className="text-xs text-gray-600 mt-2">Member Since: {pmiMembership.memberSince}</p>
                  <p className="text-xs text-gray-500 mt-1">{pmiMembership.chapter}</p>
                </div>
                <i className="fa-solid fa-certificate text-blue-600 text-lg"></i>
              </div>
            </div>
          </Accordion>
