        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="block min-w-0 flex-1">
              <div
                className={`text-xs sm:text-sm font-semibold tracking-wide truncate transition-colors duration-300 ${
              ...
              <div
                className={`text-xs font-medium truncate transition-colors duration-300 ${
                  isDarkSection ? "text-gray-300" : "text-slate-600"
                }`}
              >
                AI Engineer
              </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              {navLinks.map((link) => (
                <Link
                  ...
                  offset={-85}
                  duration={600}
                  className={`relative px-3 py-2 text-sm font-medium transition-all duration-300 group cursor-pointer
                  ${isDarkSection ? "text-gray-200 hover:text-white" : "text-slate-700 hover:text-slate-900"}
                  `}
                >
                  {link.name}
                  <span
